...
class DokumenViewModel : ViewModel() {
    ...
    private fun loadData(copDocData: DokumenKapalModel, context: Context) {
        ...
        val listData = arrayListOf(
            ...
            DokumenKapalListModel(context.getString(R.string.doc_bukukes_title), "BUKUKES", copDocData.bukuKesehatan, copDocData.bukuKesehatanDoc, copDocData.bukuKesehatanNote, false, needDoc = false),

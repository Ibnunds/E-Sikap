...
data class SanitasiModel(
    ...
    @ColumnInfo(name = "vec_air_tergenang") var vecAirTergenang: String = "",
    @ColumnInfo(name = "vec_ruang_mesin") var vecRuangMesin: String = "",
    @ColumnInfo(name = "vec_fasilitas_medik") var vecFasilitasMedik: String = "",
    @ColumnInfo(name = "vec_area_lainnya") var vecAreaLainnya: String = "",
    @ColumnInfo(name = "resiko_sanitasi") var resikoSanitasi: String = "",
    @ColumnInfo(name = "masalah_kesehatan") var masalahKesehatan: String = "",
    @ColumnInfo(name = "tanda_vektor") var tandatandaVektor: String = "",
